...
INSERT INTO `play_activity` VALUES (314312344010231808,'测试步骤活动','/upload/2026-03-31/17749370568554486713.png','',4,0,0,1,'2026-03-31 06:18:11','2026-04-04 06:18:14',0,7,0,1,NULL,NULL,'2026-03-31 06:18:22','2026-04-01 19:34:26',NULL);
...
INSERT INTO `play_activity_join` VALUES (314859666888724480,314312344010231808,314851091227348992,0,0,NULL,NULL,NULL,NULL,NULL,'2026-04-01 18:33:14','2026-04-01 18:33:14',NULL),(314875065189535744,314312344010231808,314874015548182528,1,2,NULL,NULL,NULL,NULL,NULL,'2026-04-01 19:34:26','2026-04-01 19:45:22',NULL);
...
INSERT INTO `play_activity_reward` VALUES (314312543306780672,314312344010231808,1,5,'5元现金，完成活动立刻到手',0,NULL,NULL,'2026-03-31 06:19:10','2026-03-31 06:19:10',NULL),(314660740172615680,314312344010231808,2,10,'10优惠卷，完成活动立即到手',0,NULL,NULL,'2026-04-01 05:22:47','2026-04-01 05:22:47',NULL),(314660828093616128,314312344010231808,3,10,'10点经验值，完成活动立即到手',0,NULL,NULL,'2026-04-01 05:23:08','2026-04-01 05:23:08',NULL),(314661005357486080,314312344010231808,4,10,'10天会员，完成活动立即到手',0,NULL,NULL,'2026-04-01 05:23:50','2026-04-01 18:32:55',NULL);
...
INSERT INTO `play_activity_step` VALUES (314312696793141248,314312344010231808,1,'复制链接到拼多多app搜索',0,'','复制链接到拼多多app搜索11','https://pic4.zhimg.com/v2-267217db1a16cf81a50184ea7d520289_1440w.jpg',0,0,NULL,NULL,'2026-03-31 06:19:47','2026-04-01 19:45:15',NULL),(314313291071492096,314312344010231808,2,'填写手机号',0,'','','',0,0,NULL,NULL,'2026-03-31 06:22:08','2026-04-01 19:45:33',NULL),(314313340186791936,314312344010231808,3,'请上传图片',3,'','请上传图片2','https://pic4.zhimg.com/v2-267217db1a16cf81a50184ea7d520289_1440w.jpg',1,0,NULL,NULL,'2026-03-31 06:22:20','2026-04-01 05:20:22',NULL),(314863152154021888,314312344010231808,1,'示例文字',1,'','','',0,3,NULL,NULL,'2026-04-01 18:47:05','2026-04-01 18:47:35',NULL),(314863206776442880,314312344010231808,1,'示例图片',3,'','','/upload/2026-04-01/17750346920439553952.png',0,4,NULL,NULL,'2026-04-01 18:47:18','2026-04-01 18:48:07',NULL);
...
INSERT INTO `play_activity_step_log` VALUES (314875074492502016,314312344010231808,314312696793141248,314875065189535744,314874015548182528,0,'','',0,NULL,NULL,NULL,0,0,'2026-04-01 19:34:28','2026-04-01 19:34:28',NULL),(314877817651204096,314312344010231808,314313291071492096,314875065189535744,314874015548182528,1,'测试数据1','',0,NULL,NULL,NULL,0,0,'2026-04-01 19:45:22','2026-04-01 19:45:22',NULL);
...
INSERT INTO `play_balance_log` VALUES (314854091920510976,314851091227348992,4,314312543306780672,5,0,5,'活动奖励-余额',NULL,NULL,'2026-04-01 18:11:05','2026-04-01 18:11:05',NULL);
/*!40000 ALTER TABLE `play_balance_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `play_banner`
--

DROP TABLE IF EXISTS `play_banner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `play_banner` (
  ...
  `link_type` tinyint NOT NULL DEFAULT '1' COMMENT '跳转类型: 1内页 2外链 3活动页 4商品页 5陪玩师页 6唤醒App',
  `link_value` varchar(500) NOT NULL DEFAULT '' COMMENT '跳转值(页面路径/URL/业务ID/App Scheme)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='首页Banner轮播';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `play_banner`
--

LOCK TABLES `play_banner` WRITE;
/*!40000 ALTER TABLE `play_banner` DISABLE KEYS */;
/*!40000 ALTER TABLE `play_banner` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `play_member` VALUES (314630202082725888,'17770244662','2h09l8OYXHuljw3anv4EmYilKi2qExEZ','用户4662','',0,0,NULL,0,0,0,1,'2026-04-01 03:47:18',NULL,NULL,'2026-04-01 03:21:26','2026-04-01 03:47:18',NULL),(314630410782904320,'17770244663','aV47PIG830lWex8IgRYXrUtTTFghyM6J','用户4663','',0,0,NULL,0,0,0,1,'2026-04-01 03:22:15',NULL,NULL,'2026-04-01 03:22:15','2026-04-01 03:22:15',NULL),(314851091227348992,'17770244661','KKrobA1JpjnP8GhLLKDpaZcRx7GJ2fXI','用户4661','',0,0,NULL,0,5,0,1,'2026-04-01 17:59:10',NULL,NULL,'2026-04-01 17:59:10','2026-04-01 18:11:05',NULL),(314874015548182528,'13900001111','wqYLY0duOIPQG6RqDOxD7h5oLE8RNr7f','用户1111','',0,314859377867624448,NULL,0,0,0,1,'2026-04-01 19:48:46',NULL,NULL,'2026-04-01 19:30:15','2026-04-01 19:48:46',NULL);
...
INSERT INTO `play_member_level` VALUES (314859377867624448,'普通会员',1,'/upload/2026-04-01/17750346920439553952.png',10,98,0,1,NULL,NULL,'2026-04-01 18:32:05','2026-04-01 18:32:05',NULL),(314859501305991168,'白银会员',2,'/upload/2026-04-02/17750683468693802028.png',100,95,0,1,NULL,NULL,'2026-04-01 18:32:35','2026-04-01 18:32:35',NULL);
...
CREATE TABLE `play_message` (
  ...
  `member_id` bigint NOT NULL COMMENT '接收者会员ID',
  `title` varchar(200) NOT NULL DEFAULT '' COMMENT '消息标题',
  `content` text COMMENT '消息内容',
  `msg_type` tinyint NOT NULL DEFAULT '1' COMMENT '消息类型 1=系统通知 2=订单消息 3=活动消息',
  `biz_id` varchar(64) DEFAULT '' COMMENT '关联业务ID（订单ID/活动ID等）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='会员消息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `play_withdraw`
--

DROP TABLE IF EXISTS `play_withdraw`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `play_withdraw` (
  `id` bigint NOT NULL COMMENT '提现ID',
  `coach_id` bigint NOT NULL COMMENT '陪玩师ID',
  `member_id` bigint NOT NULL COMMENT '会员ID',
  `amount` int NOT NULL DEFAULT '0' COMMENT '提现金额(分)',
  `status` tinyint NOT NULL DEFAULT '0' COMMENT '状态 0=待审核 1=已打款 2=已拒绝',
  `reason` varchar(500) DEFAULT '' COMMENT '拒绝原因',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='陪玩师提现记录';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `play_withdraw`
--

LOCK TABLES `play_withdraw` WRITE;
/*!40000 ALTER TABLE `play_withdraw` DISABLE KEYS */;
/*!40000 ALTER TABLE `play_withdraw` ENABLE KEYS */;
UNLOCK TABLES;
